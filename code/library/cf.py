...
# db 계정
db_id='' # [mysql ID를 넣어주세요] / put an name of db ex) bot  > username of database
# db ip
db_ip='localhost'
# db 패스워드
db_passwd='248600' # [mysql password 를 넣어주세요]
...
imi1_accout=" " # [모의투자 계좌번호를 넣어주세요. 주의! 10자리 계좌번호입니다. 모의투자는 8자리 계좌번호 뒤에 11, 실전은 10이 붙어 있음]
